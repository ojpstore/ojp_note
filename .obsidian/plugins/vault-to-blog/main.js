...
// src/suggester/MarkdownFileSuggester.ts
var import_obsidian4 = require("obsidian");
var MarkdownFileSuggester = class extends import_obsidian4.AbstractInputSuggest {
  constructor(app, inputEl, sourceDir) {
    super(app, inputEl);
    this.sourceDir = sourceDir;
  }
  getSuggestions(query) {
    return this.app.vault.getMarkdownFiles().map((it) => (0, import_obsidian4.normalizePath)(it.path)).filter((it) => it.startsWith(`${this.sourceDir}/`)).filter((it) => it.contains(query));
  }
  renderSuggestion(value, el) {
    el.setText(value);
  }
...
// src/layout/settingTab.ts
var VTBSettingTab = class extends import_obsidian5.PluginSettingTab {
  ...
  createSourceDirSetting(containerEl) {
    ...
    const setting = new import_obsidian5.Setting(containerEl).setName("Source Dir").setDesc(desc).setTooltip("Select a directory that contains markdown files, images or other files for publishing to GitHub Pages.").addSearch((cb) => {
      inputEl = cb.inputEl;
  ...
  async saveSourceDirSetting(inputEl) {
    if (!this.isValidSourceDir(inputEl == null ? void 0 : inputEl.value)) {
      new import_obsidian5.Notice("Invalid directory path.", 3e3);
    ...
    this.display();
    new import_obsidian5.Notice("Setting saved.");
  }
  isValidSourceDir(sourceDir) {
    const directories = this.app.vault.getAllFolders(true).map((it) => (0, import_obsidian5.normalizePath)(it.path));
    return directories.includes(sourceDir);
  }
  createIndexFileSetting(containerEl) {
    let inputEl;
    ...
    const setting = new import_obsidian5.Setting(containerEl).setName("Index File").setDesc(desc).setTooltip("Select an index markdown file under Source Dir. Leave empty to use default home.html.").addSearch((cb) => {
      inputEl = cb.inputEl;
  ...
  async saveIndexFileSetting(inputEl) {
    var _a2;
    if (!this.settings.sourceDir) {
      new import_obsidian5.Notice("Source Dir must be selected first.", 3e3);
      return;
    }
    const selectedPath = (0, import_obsidian5.normalizePath)((_a2 = inputEl == null ? void 0 : inputEl.value) != null ? _a2 : "");
    if (selectedPath !== "" && !this.isValidIndexFile(selectedPath)) {
      new import_obsidian5.Notice("Invalid index markdown file path.", 3e3);
  ...
  isValidIndexFile(indexFilePath) {
    if (!indexFilePath.endsWith(".md")) {
      return false;
    }
    const markdownFiles = this.app.vault.getMarkdownFiles().map((it) => (0, import_obsidian5.normalizePath)(it.path));
  ...
  createRepositoryUrlSetting(containerEl) {
    ...
    const setting = new import_obsidian5.Setting(containerEl).setName("Repository URL").setDesc(desc).setTooltip("Enter a valid GitHub Pages repository URL.").addText((cb) => {
      inputEl = cb.inputEl;
  ...
  async saveRepositoryUrlSetting(inputEl) {
    if (await this.gitUtils.isRemoteValid(inputEl.value)) {
      ...
      new import_obsidian5.Notice(`Invalid repository URL.`);
  ...
  createCommentsSetting(containerEl) {
    ...
    new import_obsidian5.Setting(containerEl).setName("Comments layout").setHeading().setDesc(desc);
    desc = new DocumentFragment();
    desc.createDiv({ text: "Enable Utterances comments layout." });
    new import_obsidian5.Setting(containerEl).setDesc(desc).setName("Enable Utterances comments layout").addToggle((cb) => {
    ...
    if (this.settings.isEnableComments) {
      new import_obsidian5.Setting(containerEl).setName("Repo").addText((cb) => {
      ...
      new import_obsidian5.Setting(containerEl).setName("Theme").addDropdown((cb) => {
        cb.addOptions({
  ...
  createButton(containerEl) {
    const setting = new import_obsidian5.Setting(containerEl).addButton((cb) => {
  ...
  async activate() {
    if (this.isValidSourceDir(this.settings.sourceDir) && await this.gitUtils.isRemoteValid(this.settings.repositoryUrl)) {
      ...
      new import_obsidian5.Notice("Invalid directory path or invalid repository URL.");
    }
  }
  async deactivate() {
  ...
  async doActivate() {
    ...
    new import_obsidian5.Notice("Activate Succeed.", noticeDuration);
  }
};
...
var FileUtils = class {
  ...
  async copySourceToDest(noticeDuration) {
    ...
    try {
      ...
      new import_obsidian6.Notice("Succeeded in copying source to destination.", noticeDuration);
    } catch (error) {
...
${error.message}`;
  ...
  async cleanGitDirectory(noticeDuration) {
    try {
      ...
      new import_obsidian6.Notice("Succeeded in cleaning Git directory.", noticeDuration);
    } catch (error) {
...
${error.message}`;
  ...
  async cleanSourceDest(noticeDuration) {
    try {
      ...
      new import_obsidian6.Notice("Succeeded in cleaning source destination.", noticeDuration);
    } catch (error) {
...
${error.message}`;
  ...
  async copyTypesJson(noticeDuration) {
    try {
      ...
      new import_obsidian6.Notice("Succeeded in copying types.json file.", noticeDuration);
    } catch (error) {
  ...
  async backupGitDirectory(noticeDuration) {
    if (import_fs2.default.existsSync(this.paths.gitPath())) {
      ...
      try {
        ...
        new import_obsidian6.Notice("Succeeded in backing up Git directory.", noticeDuration);
      } catch (error) {
...
${error.message}`;
  ...
  async cleanGitBackupDirectory(noticeDuration) {
    try {
      ...
      new import_obsidian6.Notice("Succeeded in cleaning Git backup directory.", noticeDuration);
    } catch (error) {
  ...
  async restoreGitDirectory(noticeDuration) {
    if (import_fs2.default.existsSync(this.paths.gitBackupPath())) {
      ...
      try {
        ...
        new import_obsidian6.Notice("Succeeded in restoring Git directory.", noticeDuration);
      } catch (error) {
...
${error.message}`;
  ...
  async unzipReactApp(noticeDuration) {
    if (import_fs2.default.existsSync(this.paths.reactZipPath())) {
      ...
      new import_obsidian6.Notice("Succeeded in unzipping react-app.", noticeDuration);
    } else {
      new import_obsidian6.Notice("Something went wrong while unzipping react-app. Please try again.", noticeDuration);
    }
  }
  existReactApp() {
  ...
  async downloadReactApp(noticeDuration) {
    ...
    if (!import_fs2.default.existsSync(this.paths.reactZipPath())) {
      new import_obsidian6.Notice("Started to download react-app.", noticeDuration);
  ...
  async doDownloadReactApp(url, noticeDuration) {
    try {
      ...
      if (response.statusCode === 302 || response.statusCode === 301) {
        ...
        new import_obsidian6.Notice(`Succeeded in downloading react-app.`, noticeDuration);
      }
    } catch (error) {
...
var GitUtils = class {
  ...
  async initializeGit(options, noticeDuration) {
    try {
      ...
      new import_obsidian7.Notice("Succeeded in initializing Git.", noticeDuration);
    } catch (error) {
      const message = `Failed to initialize Git.
${error.message}`;
      new import_obsidian7.Notice(message, noticeDuration);
      console.error(message);
    }
  }
  async addRemote(options, noticeDuration) {
    try {
      ...
      new import_obsidian7.Notice("Succeeded in adding remote.", noticeDuration);
    } catch (error) {
 ...
 ${error.message}`;
  ...
  async removeRemote(options, noticeDuration) {
    try {
      ...
      new import_obsidian7.Notice("Succeeded in removing remote.", noticeDuration);
    } catch (error) {
...
${error.message}`;
  ...
  async stageChanges(files, options, noticeDuration) {
    try {
      await git.cwd(options.cwd);
      await git.add(files);
      new import_obsidian7.Notice("Succeeded in staging changes.", noticeDuration);
    } catch (error) {
...
${error.message}`;
  ...
  async removeFiles(files, options, noticeDuration) {
    try {
      await git.cwd(options.cwd);
      await git.rm(files);
      new import_obsidian7.Notice("Succeeded in removing files.", noticeDuration);
    } catch (error) {
...
${error.message}`;
  ...
  async stageAllChanges(options, noticeDuration) {
    try {
      await git.cwd(options.cwd);
      await git.add(".");
      new import_obsidian7.Notice("Succeeded in staging all changes.", noticeDuration);
    } catch (error) {
...
${error.message}`;
  ...
  async commitChanges(options, noticeDuration, message = "Blog published by VTB") {
    try {
      ...
      new import_obsidian7.Notice("Succeeded in committing changes.", noticeDuration);
    } catch (error) {
      const message2 = `Failed to commit changes. There might be no changes to commit.
${error.message}`;
      new import_obsidian7.Notice(message2, noticeDuration);
  ...
  async pushToRemote(options, noticeDuration) {
    try {
      ...
      new import_obsidian7.Notice("Succeeded in pushing to remote.", noticeDuration);
    } catch (error) {
...
${error.message}`;
  ...
  async stageReactApp(options, noticeDuration) {
    try {
      ...
      await git.cwd(options.cwd);
      await git.add(files);
      new import_obsidian7.Notice("Succeeded in staging react-app.", noticeDuration);
    } catch (error) {
...
// src/layout/VTBPublishManager.ts
var VTBPublishManager = class extends import_obsidian8.Modal {
  constructor(app, gitUtils, paths, fileUtils) {
    ...
    this.createPublishButton = (buttonContainer) => {
      const publishButton = new import_obsidian8.ButtonComponent(buttonContainer);
      ...
      publishButton.onClick(async () => {
        ...
        if (paths.length > 0) {
          ...
          this.gitUtils.pushToRemote(this.options, this.noticeDuration).then(() => {
            new import_obsidian8.Notice("Published successfully");
            this.close();
          });
        }
      });
    ...
    this.createUnpublishButton = (buttonContainer) => {
      const unpublishButton = new import_obsidian8.ButtonComponent(buttonContainer);
      ...
      unpublishButton.onClick(async () => {
        if (confirm("Are you sure you want to unpublish selected posts?")) {
          ...
          if (paths.length > 0) {
            ...
            await this.gitUtils.commitChanges(this.options, this.noticeDuration, commitMessage);
            this.gitUtils.pushToRemote(this.options, this.noticeDuration).then(() => {
              new import_obsidian8.Notice("Unpublished successfully");
              this.close();
            });
          }
        }
    ...
    this.createClearButton = (buttonContainer) => {
      const clearButton = new import_obsidian8.ButtonComponent(buttonContainer);
...
var VaultToBlog = class extends import_obsidian9.Plugin {
  async onload() {
  ...
  async checkVersion() {
    if (this.settings.version !== this.manifest.version) {
      if (this.settings.isActivated) {
        new import_obsidian9.Notice("VTB plugin is deactivated due to detection of changing version. Please reactivate.", 5e3);
  ...
  async doDeactivate() {
    ...
    await this.renderStatusBar();
    new import_obsidian9.Notice("Deactivate Succeed.", noticeDuration);
  }
  async saveSettings() {
