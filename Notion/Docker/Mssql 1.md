---
base: "[[Docker.base]]"
cover: "[[Notion/Docker/attach/Mssql 1.jpeg]]"
...
- **Environment Variables**
    ...
    - MSSQL_PID : 컨테이너가 실행될 제품 ID (PID) 또는 에디션. 허용 가능한 값
        ...
        - Developer : Developer Edition을 사용하여 컨테이너를 실행합니다 (MSSQL_PID 환경 변수가 제공되지 않은 경우 기본값 임)
...
- mssql 2022
```docker
docker run --name mssql2022 -p 1533:1433 -v /volume1/docker/mssql:/var/opt/mssql -e ACCEPT_EULA=Y -e TZ='Asia/Seoul' -e SA_PASSWORD=비밀번호 mcr.microsoft.com/mssql/server:2022-latest
```

- SQL Sever 에이전트 활성화하기 on Docker - bash
    - 관련주소 : [https://babocoding.tistory.com/125](https://babocoding.tistory.com/125)
```docker
/opt/mssql/bin/mssql-conf set sqlagent.enabled true
```
![[mssql2022_agent_menu 1.png]]
![[mssql_agent_bash 1.png]]
